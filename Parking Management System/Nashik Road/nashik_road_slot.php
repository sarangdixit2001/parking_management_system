...
<head>
    ...
    <title>Select Your Slot at NSK Rd</title>
                ...
                document.querySelector(" #scroll").addEventListener("click", ()=> {
                            ...
                            <div class="container bg-dark text-light p-3 rounded my-4">
                                <div class="d-flex align-items-center justify-content-between">
                                    <h2><i class="bi bi-truck"></i> Slots At Nashik Rd</h2>
                            ...
                            <div class="container mt-4 p-0">
                                <table class="table table-hover text-center">
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        $query = "SELECT * FROM `nashik_rd_slot`WHERE `Status`='Available' ";
                            ...
                            <script>
                                function confirm_rem(id) {
                                    if (confirm("Are you sure,you want to book this slot?")) {
                                        ...
                                        window.location.href = "crud_nashik_road.php?rem=" + id;
                                    }
                                }
                            </script>
