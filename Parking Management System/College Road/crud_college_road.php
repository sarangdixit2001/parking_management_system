...
if(isset($_GET['rem']) && $_GET['rem']>0)
{
    ...
    $query="UPDATE `college_slot` SET `Status`='BOOKED' WHERE `slot_number`='$fetch[slot_number]'";
    if(mysqli_query($con,$query)){
        echo '<script>alert("Booking Successful !!! You Can Park now")  window.location.href = "crud_college_road.php?rem="; </script>';
