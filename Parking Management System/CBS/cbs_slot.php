...
<head>
    ...
    <title>Select Your Slot at CBS </title>
                ...
                document.querySelector(" #scroll").addEventListener("click", ()=> {
                            ...
                            <div class="container bg-dark text-light p-3 rounded my-4">
                                <div class="d-flex align-items-center justify-content-between">
                                    <h2><i class="bi bi-truck"></i> Slots At CBS</h2>
                            ...
                            <div class="container mt-4 p-0">
                                <table class="table table-hover text-center">
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        $query = "SELECT * FROM `cbs_slot`WHERE `Status`='Available' ";
                                        ...
                                        while ($fetch = mysqli_fetch_assoc($result)) {
                                            ...
                                            <button onclick="confirm_rem($fetch[slot_number])" class="btn btn-primary">BOOK NOW</i></button>
                            ...
                            <script>
                                function confirm_rem(id) {
                                    if (confirm("Are you sure,you want to book this cbs_slot?")) {

                                        window.location.href = "crud_cbs.php?rem=" + id;
                                    }
                                }
                            </script>
